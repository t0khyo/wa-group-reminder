...
async function testFunctionCalling() {
    ...
    console.log("-".repeat(60));
    const test1 = await aiService.generateReply("Remind me to submit the weekly report tomorrow at 3pm", testChatId);
    ...
    console.log("-".repeat(60));
    const test2 = await aiService.generateReply("Set a reminder to call the client in 2 hours", testChatId);
    console.log("User:", "Set a reminder to call the client in 2 hours");
    console.log("AI:", test2);
    // Test 3: List reminders
    console.log("\n📋 Test 3: List Reminders");
    console.log("-".repeat(60));
    const test3 = await aiService.generateReply("Show me all my active reminders", testChatId);
    ...
    console.log("-".repeat(60));
    const test4 = await aiService.generateReply("Can you list my reminders first?", testChatId);
    console.log("User:", "Can you list my reminders first?");
    console.log("AI:", test4);
    // Test 5: Contextual conversation
    console.log("\n💬 Test 5: Contextual Conversation");
    console.log("-".repeat(60));
    const test5a = await aiService.generateReply("I need to remember something", testChatId);
    console.log("User:", "I need to remember something");
    console.log("AI:", test5a);
    const test5b = await aiService.generateReply("To review the code tomorrow morning at 9am", testChatId);
    ...
    console.log("-".repeat(60));
    const test6a = await aiService.generateReply("Remind me tomorrow", testChatId);
    console.log("User:", "Remind me tomorrow");
    console.log("AI:", test6a);
    const test6b = await aiService.generateReply("About the team standup at 10am", testChatId);
